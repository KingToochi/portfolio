    ...
    <div className="min-h-screen bg-slate-50 py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          ...
          <p className="text-gray-600 text-lg mb-8">Sales management dashboard with revenue tracking, pipeline visualization, forecasting, and team performance metrics.</p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["React", "ApexCharts", "TailwindCSS", "REST API"].map((tech, i) => (
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-slate-100 rounded-lg h-64 flex items-center justify-center">
              <p className="text-gray-500">Sales Dashboard Preview</p>
            </div>
          </div>
